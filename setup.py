...
def requirements():
    ...
    banner()
    print(gr + '[' + cy + '+' + gr + ']' + cy +
          ' it will take upto a min to install csv merge.')
...
try:
    ...
    ( --help    / -h ) show this msg 
        ...
        print('\n' + gr + '[' + re + '!' + gr + ']' +
              cy + ' unknown argument : ' + sys.argv[1])
        print(gr + '[' + re + '!' + gr + ']' + cy + ' for help use : ')
        print(gr + '$ python3 setup.py -h' + '\n')
except IndexError:
    print('\n' + gr + '[' + re + '!' + gr + ']' +
          cy + ' no argument given : ' + sys.argv[1])
    print(gr + '[' + re + '!' + gr + ']' + cy + ' for help use : ')
    print(gr + '[' + re + '!' + gr + ']' + cy +
          ' https://github.com/azraf122312/Telegram_BotScraper.git#-how-to-install-and-use')
    print(gr + '$ python3 setup.py -h' + '\n')
